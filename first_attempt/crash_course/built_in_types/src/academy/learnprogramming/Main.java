...
//        System.out.printf("long minimum = %s, maximum= %s%n", Long.MIN_VALUE, Long.MAX_VALUE);
        ...
        System.out.printf("float minimum = %s, maximum= %s%n", Float.MIN_VALUE, Integer.MAX_VALUE);
        System.out.printf("double minimum = %s, maximum= %s%n", Double.MIN_VALUE, Long.MAX_VALUE);
        ...
        BigDecimal z = new BigDecimal("123.456789012345678987654321");
